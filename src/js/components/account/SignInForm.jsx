...
class SignInForm extends Component {
  constructor(props) {
    ...
    if (typeof localStorage.getItem('remember') === 'string' && typeof localStorage.getItem('account') === 'string') {
  ...
  componentDidMount() {
    if (this.props.loggedIn) {
      ...
      if (typeof this.props.loginStore.user !== 'undefined' && this.props.loginStore.user !== null) {
