  ...
  'marks': [
    {
      ...
      'encode': {
        'enter': {
          ...
          'tooltip': {'signal': 'datum[\'browserFamily\'] + \': \' + datum[\'ff_sum_percent\'] + \'%\''}
        }
      }
    },
    {
    ...
    },
    {
      ...
      'encode': {
        'enter': {
          'text': {'signal': 'datum[\'browserMajorVer\'] == \'\' ? \'\' : \'v.\' + datum[\'browserMajorVer\']'},
          'x': {'signal': 'width / 2'},
          'y': {'signal': 'height / 2'},
          'radius': {'value': 115},
