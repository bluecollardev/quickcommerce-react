...
class CatalogFilterBar extends Component {
  ...
  componentDidMount() {
    ...
    if (typeof rangeSlider !== 'undefined' && rangeSlider !== null) {
      let dataStartMin = parseInt(rangeSlider.parentNode.getAttribute('data-start-min'), 10), dataStartMax = parseInt(rangeSlider.parentNode.getAttribute('data-start-max'), 10),
        dataMin = parseInt(rangeSlider.parentNode.getAttribute('data-min'), 10), dataMax = parseInt(rangeSlider.parentNode.getAttribute('data-max'), 10),
        dataStep = parseInt(rangeSlider.parentNode.getAttribute('data-step'), 10)

      let valueMin = document.querySelector('.ui-range-value-min span'), valueMax = document.querySelector('.ui-range-value-max span'),
        valueMinInput = document.querySelector('.ui-range-value-min input'), valueMaxInput = document.querySelector('.ui-range-value-max input')
            ...
            <div className='row'>
              ...
              <div className='col-md-3'>
                ...
                <div className='widget widget-catesgories'>
                  ...
                  <form method='post' className='price-range-slider' data-start-min={priceRange.startMin} data-start-max={priceRange.startMax} data-min={priceRange.min} data-max={priceRange.max}
