                ...
                <form>
                    ...
                    <Col sm={12}>
                        <FormGroup className='col-sm-12 col-md-4 col-lg-3'>
                            ...
                            <FormControl name={mappings.PASSWORD} type='password' {...this.props.fields(mappings.PASSWORD, this.props.getMappedValue(mappings.PASSWORD, data))} />
                        </FormGroup>
                        
                        <FormGroup className='col-sm-12 col-md-4 col-lg-3'>
                            <ControlLabel>Confirm Password*</ControlLabel>
                            <FormControl name={mappings.CONFIRM} type='password' {...this.props.fields(mappings.CONFIRM)} />
                        </FormGroup>
