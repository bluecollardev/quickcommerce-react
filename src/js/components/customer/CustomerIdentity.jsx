...
import { IdTypeDropdown } from '../form/Dropdown.jsx'
      ...
      <div>
        <form>
          <Col xs={12} className='col-md-flex col-lg-flex'>
            {this.props.title && (<h4 className='fieldset-heading flex-md-full flex-lg-full'>{this.props.title}</h4>)}
            ...
            <FormGroup className='col-sm-2 flex-md-50 flex-lg-16'>
              ...
              <Autocomplete
                ...
                onChange={(event, value) => {
                  ...
                  this.setState(assign({}, this.state, {data: assign({}, this.state.data, {[mappings.ZONE]: value})}))
                }}
                onSelect={(value, item) => {
                ...
                inputProps={assign(this.props.fields(mappings.ZONE, data[mappings.ZONE]), { className: 'form-control' })}
              />
            ...
            <FormGroup className='col-sm-2 flex-md-50 flex-lg-16'>
              ...
              <Autocomplete
                ...
                onChange={(event, value) => {
                  ...
                  this.setState(assign({}, this.state, {data: assign({}, this.state.data, {[mappings.COUNTRY]: value})}))
                ...
                inputProps={assign(this.props.fields(mappings.COUNTRY, data[mappings.COUNTRY]), { className: 'form-control' })}
              />
