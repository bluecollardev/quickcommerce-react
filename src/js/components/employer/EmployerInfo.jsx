                ...
                <form>
                    <Col sm={12} lg={6}>
                        <FormGroup className='col-sm-3 col-md-3 col-lg-3'>
                            ...
                            <EmploymentTypeDropdown items={SettingStore.employmentTypes} name='employment_type' componentClass='select' value={data.employment_type} onChange={(e) => this.props.setField(e)} />
                        </FormGroup>
