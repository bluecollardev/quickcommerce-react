                    ...
                    <div>
                      <div className="product-gallery">
                        <ul className="product-gallery-preview">
                          <li id="preview01"><img src="img/template/acecoffeeroasters/prd-fhd/ACE-8.jpg" alt="Product" /></li>
                          <li id="preview02" className="current"><img src="img/template/acecoffeeroasters/prd-fhd/ACE-15.jpg" alt="Product" /></li>
                          <li id="preview03"><img src="img/template/acecoffeeroasters/prd-fhd/ACE-11.jpg" alt="Product" /></li>
                        </ul>
