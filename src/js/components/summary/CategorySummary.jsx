      ...
      <div className="summary entry-summary">
        ...
        <div className="product-details">
          <div className="row">
            ...
            <div className="col-sm-12 col-md-4 featured_image top_row" style={{
            ...
            <div className="col-sm-12 col-md-5 price bottom_row" style={{ height: 114 }}>
              <div className="product_section">
                <div className="options">
                  <div className="selector-wrapper" style={{ display: 'none' }}><select className="single-option-selector" data-option="option1" id="productSelect-option-0">
                    <option value="Default Title">Default Title</option>
                  </select></div>
                  <select name="id" id="productSelect" className="product-single__variants" style={{ display: 'none' }}>
