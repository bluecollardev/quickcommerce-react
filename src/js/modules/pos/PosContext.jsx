  ...
  class PosContext extends Component {
    ...
    onSetCustomer() {
      ...
      if (typeof customerStore.customer !== 'undefined' && customerStore.customer !== null) {
        ...
        if (checkoutStore.payload.hasOwnProperty('order') && checkoutStore.payload.order !== null) {
          // Do we update?
          if (checkoutStore.payload.order.hasOwnProperty('orderId') && !isNaN(checkoutStore.payload.order.orderId) && checkoutStore.payload.order.orderId > 0) {
    ...
    render() {
      let props = Object.assign({}, this.props, {
        ...
        configureSteps: this.componentConfigureSteps, //addToCart: this.addToCart,
        //quickAddToCart: this.quickAddToCart,
        onComplete: this.onComplete,
        updateNotes: this.updateNotes,
        updatePaymentMethod: this.updatePaymentMethod,
        updateShippingMethod: this.updateShippingMethod,
        continueShopping: this.continueShopping, //refresh: this.refresh,
        ...
        changeCustomer: this.changeCustomer, //showLoginForm: this.showLoginForm,
        ...
        onSaleComplete: this.onSaleComplete, //reset: this.reset,
        categoryClicked: this.categoryClicked,
        itemClicked: this.itemClicked, //addToCartClicked: this.addToCartClicked,
        ...
        getChangeAmounts: this.getChangeAmounts, //getTotal: this.getTotal,
              ...
              <div>
                <div>
                  ...
                  <form>
                    ...
                    <FormGroup>
                      <Button block onClick={this.hideChargeModal}><h4><i className='fa fa-ban'/> Cancel</h4></Button>
                    </FormGroup>
