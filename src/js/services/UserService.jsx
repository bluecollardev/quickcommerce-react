...
class UserService extends BaseService {
  ...
  put(formData, onSuccess, onError) {
    ...
    if (id !== null) {
      axios({
        //url: QC_LEGACY_API + 'account',
        url: QC_API + 'user/' + id, //data: JSON.stringify(data), // Legacy
        data: data,
        dataType: 'json',
  ...
  updatePassword() {
    ...
    // Update user
    axios({
      url: QC_LEGACY_API + 'account/password', //data: JSON.stringify({ password: passwordModel.get('password'), confirm: passwordModel.get('confirm') }),
      type: 'PUT',
      dataType: 'json',
      contentType: 'application/json',
