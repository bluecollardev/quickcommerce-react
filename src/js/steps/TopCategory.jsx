...
export default {
  ...
  filtersApplied: function (data) {
    var productDataSource = browserDataSources.get('browser.product'), products = productDataSource.view()

    console.log('filters applied')
    console.log(products)

    if (products.length === 1) {
      var productData = products[0], windowLauncher = page.getAttribute(productData, 'Product Config', 'Category Window Launcher')
